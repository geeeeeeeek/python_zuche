          ...
          <div class="thing-infos-view">
            <div class="thing-infos">
              ...
              <div class="thing-info-box">
                ...
                <div class="translators flex-view" style="">
                  <span>续航：</span>
                  <span class="name">{{ detailData.xuhang }}</span>
                </div>
                <div class="translators flex-view" style="">
                  <span>动力：</span>
                  <span class="name">{{ detailData.dongli }}</span>
                </div>
                <div class="translators flex-view" style="">
                  <span>闲置时间：</span>
                  <span class="name">{{ detailData.xianzhi }}</span>
                </div>
                <div class="translators flex-view" style="">
                  <span>所属地区：</span>
                  <span class="name">{{ detailData.location }}</span>
                </div>
                <a-popconfirm title="确定预订?" ok-text="是" cancel-text="否" @confirm="handleOrder(detailData)">
