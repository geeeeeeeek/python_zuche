...
class Thing(models.Model):
    ...
    price = models.CharField(max_length=50, blank=True, null=True) # 价格/天
    xuhang = models.CharField(max_length=50, blank=True, null=True) # 续航
    dongli = models.CharField(max_length=50, blank=True, null=True) # 动力
    xianzhi = models.CharField(max_length=50, blank=True, null=True) # 闲置时间
    mobile = models.CharField(max_length=50, blank=True, null=True)
    age = models.CharField(max_length=10, blank=True, null=True) # 车龄
    location = models.CharField(max_length=50, blank=True, null=True) # 地区
    status = models.CharField(max_length=1, choices=STATUS_CHOICES, default='0')
    create_time = models.DateTimeField(auto_now_add=True, null=True)
